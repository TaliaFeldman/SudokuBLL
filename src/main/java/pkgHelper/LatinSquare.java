...
public class LatinSquare {
	 ...
	 * 
	 * @param puzzle             Pass in given LatinSquare puzzle (probably for
	 *               testing)
	 * @version 1.1
	 * @since Lab #1
	 */
...
// TODO: Return 'true' if iValue is found in arr
	 ...
	 * @version 1.1
	 * @since Lab #1
	 * @param iCol             The column you want returned from the two-dimensional
	 *             array
...
// TODO: Return 'true' if any element in arr is duplicate
	...
	protected int[] RemoveZeros(int[] arr) {    //changed from private to protected
...
// false;
	 ...
	 * @version 1.1
	 * @since Lab #1
	 * @param latinSquare             - pass in an instance of a possible
	 *                    LatinSquare
	 */
